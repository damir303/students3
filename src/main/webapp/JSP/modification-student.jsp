...
<div class="flex margin-top">
    ...
    <div class="midle-place">
        <h3>
            Для модификации студента заполните все поля и нажмите кнопку "Создать".
        </h3>
    </div>
</div>
...
<div class="flex margin-left margin-top">
    ...
    <div class="inputText">
        <form action="/modification-student" method="post">
            <div>
            ...
            <div>
                <input type="text" class="textInput margin-bottom" name="date" id="datepicker" value="${student.date}">
            </div>
            <input type="hidden" name="id" value="${student.id}">
            <div class="margin-bottom">
                <input type="submit" class="textInput" value="Модифицировать">
            </div>
        </form>
    </div>
</div>
